...
import com.librarymanagementsystem.state.AvailableState;
import com.librarymanagementsystem.state.ItemState;
...
public class BookCopy {
    ...
    public synchronized void placeHold(Member member) {
